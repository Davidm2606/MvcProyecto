...
namespace WebApplication1.Controllers
{
    public class AlimentoController : Controller
    {
        ...
        public AlimentoController(IApiService apiService)
        {
        ...
        public async Task<IActionResult> Index()
        {
            try
            {
                List<Alimento> productos = await _apiService.obtenerProductos();
                return View(productos);
            } catch (Exception e)
            {
                return View(new List<Alimento>());
            }
        }
        ...
        [HttpPost]
        public async Task<IActionResult> Create(Alimento producto)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> Edit(Alimento producto)
        {
